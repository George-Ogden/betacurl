...
class Stone:
    ...
    def __init__(self, color: StoneColor, position: Tuple[float, float], velocity: float, angle: float, spin: float, curling_constants: CurlingConstants = Curling.constants):
