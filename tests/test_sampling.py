...
random_strategy = RandomSamplingStrategy(action_spec=stub_game.game_spec.move_spec, observation_spec=stub_game.game_spec.observation_spec)
nn_strategy = NNSamplingStrategy(action_spec=stub_game.game_spec.move_spec, observation_spec=stub_game.game_spec.observation_spec)
zero_strategy = NNSamplingStrategy(action_spec=stub_game.game_spec.move_spec, observation_spec=stub_game.game_spec.observation_spec, model_factory=ZeroModel)
one_strategy = NNSamplingStrategy(action_spec=stub_game.game_spec.move_spec, observation_spec=stub_game.game_spec.observation_spec, model_factory=OneModel)
...
def strategy_test(strategy):
    ...
    assert actions.shape == stub_game.game_spec.move_spec.shape
    validate_actions(actions, stub_game.game_spec.move_spec)
...
def batch_strategy_test(strategy):
    ...
    assert actions.shape == (5,) + stub_game.game_spec.move_spec.shape
    validate_actions(actions, stub_game.game_spec.move_spec)
