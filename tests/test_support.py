...
def test_batch_support_to_value():
    supports = tf.constant([[1, 2, 3], [2, 3, 4]], dtype=tf.float32)
    coefficients = tf.constant([[0.1, 0.3, 0.6], [0.4, 0.6, 0.]], dtype=tf.float32)
    expected_output = tf.constant([2.5, 2.6], dtype=tf.float32)
...
def test_batch_value_to_support():
    support = tf.constant([[1, 2, 3], [2, 3, 4]], dtype=tf.float32)
    values = tf.constant([2.5, 2.6], dtype=tf.float32)
    expected_output = tf.constant([[0, .5, .5], [.4, .6, 0.]], dtype=tf.float32)
